...
<div class="form-group">
    ...
    {!! Form::mediaImage('first_image', null, ['data-shortcode-attribute' => 'first_image']) !!}
</div>

<div class="form-group">
    <label class="control-label">Second Image</label>
    {!! Form::mediaImage('second_image', null, ['data-shortcode-attribute' => 'second_image']) !!}
</div>

<div class="form-group">
    <label class="control-label">Third Image</label>
    {!! Form::mediaImage('third_image', null, ['data-shortcode-attribute' => 'third_image']) !!}
</div>
